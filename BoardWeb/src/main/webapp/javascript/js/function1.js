...
//2.함수표현식 (변수에 함수정의 담는)
// -호출(변수명으로)
let sum2 = function (num1 = 0, num2){ //함수선언문방식多 
  let result = num1 + num2            //(실제 처리되는 건 내부적으로 이 방식이 사용되는 것)
...
//**아래 "기능"을 위 매개값callback이 받아서 위 코드 실행
let sumfunc = function(n1,n2){ //어떤 값을 받을지는 모르겠지만
  return n1 + n2;              //두개의값을 더한 결과를 반환하겠다
}
