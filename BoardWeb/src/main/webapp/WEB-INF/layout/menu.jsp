    ...
    <body>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
             ...
             <c:choose>
             	<c:when test="${empty logName}"> <!-- logName eq / logName == null -->
            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="boardForm.do">글등록</a><!--로그아웃시엔 글등록메뉴안보임-->
                </c:otherwise>
			</c:choose>
