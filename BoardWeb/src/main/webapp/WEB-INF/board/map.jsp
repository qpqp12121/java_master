...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=33526cc6adb42969c71a51774b930ae8"></script>
<script>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(x,y), // 지도의 중심좌표 (위도,경도)
        level: 3 // 지도의 확대 레벨
    };
...
// 마커가 표시될 위치입니다 
var markerPosition  = new kakao.maps.LatLng(x,y); //(위도,경도)
